...
<template>
    <div class="container"> <!-- MAIN CONTAINER-->
        <div class="wallpaper"></div> <!--BACKGROUND MAIN - HEROES THEME -->
        <div class="carousel-container"> <!-- CAROUSEL CONTAINER -->

            <div class="carousel"> <!--ACTUAL CAROUSEL-->
                <div v-for="info in datiJason" class="comic-box"> <!--V-FOR cycling ON datiJason array-->
                    <img :src="info.thumb" alt="">
                    <div> {{ info.series }}</div>
                </div>
            </div>

            <div class="loadMore"> <!--LOAD MORE BUTTON-->
                <button>
                    Load More
                </button>
             </div>
        ...
        <div class="current-series"> <!--CURRENT SERIES BADGE-->
            Current series
        </div>
    </div>
</template>
